  ...
  public render(): JSX.Element {
    ...
    return (
      ...
      <Header role="headernews" className="headernews">
        <Menu onClick={this._menuOnCLicked} style={{ margin: 0 }}  mode="horizontal" className="category" defaultSelectedKeys={menuItems.includes(category) ? [''+menuItems.indexOf(category)]:['-1']} items={items} />
