    ...
    return (
      <Layout className="acontainer" role='acontainer'>
          <Header className="article">
            ...
            <Button type='default' onClick={this.onCloseButtonClicked}>CLOSE</Button>
          </Header>
          <Content className='content'>
            <div style={{ display: 'flex', flexDirection: 'column'}}>
              <img src={urlToImage} alt={title} style={{ maxWidth: 500, margin: 'auto', paddingTop: 10 }} />
              <div style={{padding: '2rem'}}>
                ...
                <p style={{ marginTop: '1em', fontSize: '1em' }}>{content}</p>
